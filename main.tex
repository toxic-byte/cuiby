...
% 注意：algorithm2e 已在 hitszthesis.sty 中加载，不要重复加载 algorithm/algorithmic
% \usepackage{algorithm}    % 与 algorithm2e 冲突，已移除
% \usepackage{algorithmic}  % 与 algorithm2e 冲突，已移除
\usepackage{booktabs} % 更美观的表格线
\usepackage{caption}  % 更灵活的标题支持
\usepackage{amsmath}
\usepackage{pifont}
% \usepackage{amsmath}  % 重复加载，已移除
