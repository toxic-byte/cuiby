...
beibei = [0.1781, 0.1814, 0.1906, 0.2111, 0.1838]  # Beibei 数据
tmall = [0.0913, 0.0920, 0.1207, 0.1111, 0.1088]  # Tmall 数据
taobao = [0.0908, 0.0941, 0.1091, 0.0969, 0.0955]  # Taobao 数据
...
# 设置坐标轴标签并加粗
plt.xlabel(r'$\beta_{low}$', fontsize=30, fontweight='bold', labelpad=-5.0)
...
# 设置坐标轴范围
plt.ylim(0.08, 0.22)
plt.xlim(0.05, 0.6)  # 设置x轴范围以适应数据

# 设置 x 轴刻度并加粗
plt.xticks(np.arange(0, 0.55, 0.1), fontsize=24, fontweight='bold')
...
# 保存为高分辨率的矢量图或位图图像
plt.savefig('low.pdf', format='pdf', dpi=600)  # 保存矢量图并设置dpi
